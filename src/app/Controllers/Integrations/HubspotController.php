...
class HubspotController extends Controller {
	...
	/*public function getImportDeals() {
		...
		foreach($items as $item){
	        ...
	        $main_array = \Product::importHubspotProperty($properties, $array);
		...
		\Product::generateDeal($main_array, $main_array['id'], $company_ids, $contact_ids);
		return ['created'=>true];
	}*/
	...
	/*public function postDealCreated($id) {
		...
		\Product::generateDeal($main_array, $id, $company_ids, $contact_ids);
		return ['created'=>true];
	}*/

	// Export Company to HubSpot
	public static function exportCompanyCreated($id) {
		$item = \Solunes\Product\App\Company::find($id);
        $array = $this->company_fields;
	...
	public static function exportContactCreated($id) {
		$item = \Solunes\Product\App\Contact::find($id);
        $array = $this->contact_fields;
	...
	/*public static function exportDealCreated($id) {
		$item = \Solunes\Product\App\Deal::find($id);
		\Product::exportDeal($item);
		return ['created'=>true];
	}*/
	...
	public function initiateHubspot() {
		$hubspot = \SevenShores\Hubspot\Factory::create(config('product.hubspot_api_key'));
		return $hubspot;
	}
